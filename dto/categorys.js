...
router.post('/add', async (req, res) => {
  try {
    ...
    await transaction.query(`INSERT INTO category (CategoryNO, CategoryName, CategoryAlias) VALUES (${categoryId},'${categoryName}', NULL)`);
    console.log('추가 성공');
...
router.post('/delete', async (req, res) => {
  try {
    ...
    await transaction.query(`DELETE FROM category WHERE CategoryNO = ${categoryId}`);
    console.log('삭제 성공');
...
router.post('/update', async (req, res) => {
  try {
    ...
    await transaction.query(`UPDATE category SET CategoryName = '${categoryName}' WHERE CategoryNO = ${categoryId}`);
    console.log('수정 성공');
...
router.post('/toggle', async (req, res) => {
  try {
    ...
    await transaction.query(`UPDATE category SET IsOn = ${switchOn} WHERE CategoryNO = ${categoryId}`);
