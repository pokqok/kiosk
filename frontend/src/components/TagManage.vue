<template>
  <v-subheader class="subheader"
    >옵션(태그) 관리
    <v-btn color="primary" @click="showAddCategory">옵션 추가</v-btn>
  </v-subheader>
  <v-divider></v-divider>
  ...
  data() {
    return {
      ...
      Tags: [
        ...
        {
          id: 4,
          name: "얼음 양? 이건 ice에만 적용시키려면 제한을 걸어야 할수도 있을듯",
        },
        { id: 5, name: "샷" },
        { id: 6, name: "토핑" },
        { id: 7, name: "포장여부?는 주문테이블에서 해야할 부분?" },
        {
          id: 8,
          name: "여기도 전용 스크롤을 추가할 예정 v-simple-table 사용해서",
        },
